...
const MainProduct = ({ product }) => {
    ...
    return (
        <div key={product.id} className='mainProdContainer'>
            {product.img && <img src={product?.img} className='prodImg2' alt={product.name} />}
            <div className='w-full flex flex-col justify-between mx-5'>
